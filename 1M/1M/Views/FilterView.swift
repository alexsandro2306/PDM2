...
struct FilterView: View {
    ...
    let availableBreeds = ["Labrador", "Poodle", "Bulldog", "Persian", "Siamese", "Golden Retriever", "Beagle", "German Shepherd","Maine Coon", "British Shorthair", "Ragdoll", "Holland Lop" , "Labrador Retriever"]
