...
struct AnimalMapViewModern: View {
    ...
    var body: some View {
                ...
                VStack {
                    HStack {
                        ...
                        VStack(spacing: 12) {
                            ...
                            // botãoanimais próximos
                            Button(action: showNearbyAnimals) {
        ...
        .onAppear {
            ...
            // Espera para obter a localizacao
    ...
    private func showNearbyAnimals() {
        guard let userLocation = locationManager.location else {
            print("Localização do user não disponível")
            return
        }
